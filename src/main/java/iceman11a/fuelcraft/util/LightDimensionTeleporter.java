...
public class LightDimensionTeleporter extends Teleporter
{
    ...
    public boolean placeInExistingPortal(Entity p_77184_1_, double p_77184_2_, double p_77184_4_, double p_77184_6_, float p_77184_8_)
    {
        ...
        {
            LightDimensionTeleporter.PortalPosition portalposition = (LightDimensionTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(j1);
            d3 = 0.0D;
        ...
        if (d3 >= 0.0D)
        {
            if (flag)
            {
                this.destinationCoordinateCache.add(j1, new LightDimensionTeleporter.PortalPosition(i, j, k, this.worldServerInstance.getTotalWorldTime()));
    ...
    public void removeStalePortalLocations(long p_85189_1_)
    {
        if (p_85189_1_ % 100L == 0L)
        {
            ...
            while (iterator.hasNext())
            {
                ...
                LightDimensionTeleporter.PortalPosition portalposition = (LightDimensionTeleporter.PortalPosition)this.destinationCoordinateCache.getValueByKey(olong.longValue());
