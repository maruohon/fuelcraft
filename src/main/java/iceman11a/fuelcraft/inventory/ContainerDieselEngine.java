...
public class ContainerDieselEngine extends ContainerTileEntityInventory{

		private TileEntityCartPainter tileEntityCartPainter;

		public ContainerDieselEngine(InventoryPlayer inventoryPlayer, TileEntityCartPainter te) {
