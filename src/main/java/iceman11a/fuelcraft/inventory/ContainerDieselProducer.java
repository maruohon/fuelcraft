...
public class ContainerDieselProducer extends ContainerTileEntityInventory {
	...
	private TileEntityDieselProducer teef;
    public int burnTime  Remaining;
    public int burnTimeFresh;
    //public int cookTime; Not needed
    //public int cookTimeFresh; Not Needed
    public int fuelProgress;
    //public int smeltingProgress; Not Needed
    public int outputBufferAmount;
    public boolean outputToEnderChest;	

	public ContainerDieselProducer(InventoryPlayer inventoryPlayer, TileEntityFuelCraftInventory te) {		
	    ...
	    public ItemStack transferStackInSlot(EntityPlayer player, int slotNum)
	    {
	        ...
	        if(slot != null && slot.getHasStack() == true)
	        {
	            ...
	            else
	            {
	                ...
	                else if (TileEntityDieselProducer.isItemFuel(stackInSlot) == true
	                        || stackInSlot.getItem() == FuelCraftItems.enderBucket)
	                {
