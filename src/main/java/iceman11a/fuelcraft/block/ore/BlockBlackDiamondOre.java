...
public class BlockBlackDiamondOre extends BlockFuelcraftBase {


	public BlockBlackDiamondOre(String name, float hardness, Material material) {		
	...
	return FuelcraftItems.BlackDiamond;
	}
