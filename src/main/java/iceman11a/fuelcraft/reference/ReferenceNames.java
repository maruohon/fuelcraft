...
public class ReferenceNames {
	...
	public static final String NAME_DIESEL_TRAIN_ENGINE				= "dieseltrainengine";
	public static final String NAME_TOKEN_CONTROLLER				= "tokencontroller";	
	...
	public static final String NAME_TILE_DIESEL_ENINE				= "Diesel Engine";
	public static final String NAME_TILE_TOKEN_CONTROLLER			= "Token Controller";
